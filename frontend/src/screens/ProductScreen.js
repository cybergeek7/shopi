...
import { PRODUCT_CREATE_REVIEW_RESET } from '../constatnts/productConstants'
...
const ProductScreen = ({ history, match }) => {
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(
      createProductRivew(match.params.id, {
        rating,
        comment,
      })
    )
...
So, [...Array(3).keys()] creates a new array of 3 elements, populated by the keys (indexes) of the Array Iterator object. */}
